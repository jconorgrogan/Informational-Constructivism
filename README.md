...
Crucially, even a single F0 event possesses latent 'texture'. This follows from information theory: the potential descriptive complexity underlying even one registered bit is vast [See Box 0b / Formal Refs]. This inherent potential provides a rich substrate for subsequent processing and compression. [See Box 0b / TODO: Formal lemma: Kolmogorov structure function / Levin's coding theorem application]. This potential complexity exists in the universal prior, providing a reservoir that later compression stages can exploit.
