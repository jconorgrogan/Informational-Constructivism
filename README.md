...
**Repetition is Inevitable Due to Finiteness: **Any system built on these limited options (finite distinctions from point 1) that keeps changing must eventually repeat its states. Recognizing "this happened again" is the simplest form of internal time and memory.
