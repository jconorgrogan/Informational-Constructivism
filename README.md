...
| :---- | :--- | :---------------------------------------------------- | :-------------------------------------------------------------------------- | :--------------------------- | :----------------------------------------------------------------------------------------------------------------------- |
| **PRE** | P1   | Distinction is possible; Null excluded.               | `README.md` (reject S₀), `LogicEmergence` (need distinction)              | **Meta-axiom; precondition**                    | Foundational starting point.                                                                                             |
| **PRE** | P2   | Finite Operational Capacity (Ledger C); Cost L=K+λE. | `OpConstr` (Box 2), `InProgress`, `SUR linearity proof.md` (Th 1)            | ***Logically flows from P1** ** (Capacity) + **Proven (IC)** (Cost L form) | Capacity is assumed; linear cost form derived from additivity/monotonicity axioms. `λ` link to thermo in `OpConstr` (Box 5). |
| **PRE** | P3   | Stability needed for process/sequences.             | `README.md` (Stable Carrier)                                                | **Logically flows from P1**                    | Necessary background for dynamics.                                                                                       |
| **PRE** | P4   | Persistence under constraint requires adaptation.     | `README.md` (Persistence), `LogicEmergence` (PO)                            | **Logically flows from P1**                     | Focuses analysis on non-halting systems.                                                                               |
