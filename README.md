...
2.  **Registration implies comparison between states *by a system*.**
...
3.  **Comparison requires that prior outcomes remain structurally accessible *to the system*.**
...
4.  **Multiple distinguishable registrations require structural separability *within the system*.**
...
5.  **The induced partial order over registered distinctions is time *for that system*.**
...
6.  **For comparisons to be coherent, a stable evaluative frame must exist *within the system*.**
...
8.  **This induces the system's internal/external boundary.**
...
10. **External distinctions that recur (and are registered by the system) are grouped into compressible patterns.**
...
11. **The stable map of externalized, organized distinctions (as modeled by the system) is space.**
