...
3.  **Significance:** \(L_O\) and its cohomology classify the types of infinitesimal changes an observer's structure can undergo relative to its connection.
